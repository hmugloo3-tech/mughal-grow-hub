        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="flex flex-wrap gap-2">
            <Button
              ...
              className={activeCategory === "all" ? "bg-primary text-primary-foreground" : "border-primary text-primary hover:bg-primary hover:text-primary-foreground"}
            >
              All
            </Button>
            {categories.map((cat) => (
              ...
              <motion.div key={product.id} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <div className="glass-card-hover rounded-xl overflow-hidden group h-full flex flex-col">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    ...
                    <a
                      href={`https://wa.me/916006561732?text=Hi! I want to order: ${encodeURIComponent(product.name)} (₹${product.price})`}
                      target="_blank"
