...
import { Search, Filter, ShoppingCart, Check, Eye, X } from "lucide-react";
            ...
            <>
              ...
              >
                <div className="flex items-center justify-between p-4 border-b border-border">
                  <h3 className="font-semibold text-foreground text-lg">Filter Products</h3>
                ...
                {activeCategory !== "all" && (
                  <div className="p-4 border-t border-border">
                    <Button variant="outline" className="w-full" onClick={() => { setActiveCategory("all"); setFilterOpen(false); }}>
                      Clear Filter
                    </Button>
                  </div>
                )}
        ...
        {activeCategory !== "all" && (
          <div className="lg:hidden flex items-center gap-2 mb-4">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 bg-primary/10 text-primary text-xs font-medium px-3 py-1.5 rounded-full"
            >
              ...
              <motion.div key={product.id} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
                <div className="rounded-xl overflow-hidden bg-card border border-border group h-full flex flex-col hover:shadow-[var(--shadow-hover)] transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="p-3 md:p-5 flex flex-col flex-1">
                    ...
                    {/* Benefits - hidden on small mobile */}
